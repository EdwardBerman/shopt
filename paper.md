...
As outlined in the statement of need, `ShOpt` was built to scale. It is able to produce PSF models at sizes needed for the JWST NIRCam Images and provide sufficient diagnostics to evaluate how well it captured the "wings" of the PSF. The JWST paves the way for potentially the highest resolution mass map of the Universe ever, AGN models in galaxies, and a stronger understanding of strong lensing. These science goals neccesitate good PSF modeling and underscore the importance of `ShOpt`.

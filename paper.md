...
![The plot on the left shows the average cutout of all of the stars in a supplied catalog. Likewise, plot in the middle represents the average point spread function model. The plot on the right represents the average normalized error between the observed star cutouts and the point spread function model.](spikey.png)

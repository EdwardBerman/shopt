...
(2) The pixel scale of the NIRCam detectors are 0.03 and 0.06 arcseconds per pixel. [@10.1117/12.489103; @BSPIE; @20052005SPIE]. To fully capture the wings of the PSF at this pixel scale requires vignettes anywhere from $131$ by $131$ to $301$ by $301$ pixels across. These vignette sizes are much larger than the sizes used in previous large surveys such as DES [@Jarvis_2020] and SuperBIT [@mccleary2023lensing] and forces us to evaluate how well existing PSF fitters scale to this size. The DES and SuperBIT surveys needed PSF sizes of $17$ by $17$ and $48$ by $48$, an order of magnitude less than the JWST PSF sizes.

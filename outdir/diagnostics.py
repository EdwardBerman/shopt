...
fig6, axes6 = plt.subplots(2,1, figsize=(30, 10))
bins = np.linspace(-1, 1, 21)
axes6[1].hist(mreHist(vignets, pixelGrid), bins=bins, color = "lightblue", ec="red", lw=3)
axes6[1].set_xlabel('Relative Error', fontsize=20)
axes6[1].set_ylabel('Frequency',fontsize=20)
axes6[1].set_yscale('log')
axes6[1].set_title(f'Relative Error Histogram (logscale)', fontsize=30)
axes6[0].hist(mreHist(vignets, pixelGrid), bins=bins, color = "lightblue", ec="red", lw=3)
axes6[0].set_xlabel('Relative Error', fontsize=20)
axes6[0].set_ylabel('Frequency',fontsize=20)
axes6[0].set_title(f'Relative Error Histogram\n $\mu = {np.mean(mreHist(vignets, pixelGrid))}$,  $\sigma = {np.std(mreHist(vignets, pixelGrid))}$', fontsize=30)
fig6.subplots_adjust(hspace=1, wspace=0.3)
